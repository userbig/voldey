...
const i18n = {
  pl: {
    ...
    hero_desc: "Specjalizujemy się w kompleksowych przemysłowych pracach montażowych. Wielkość zespołu i zakres prac dostosowujemy do wymagań zleceniodawcy i specyfiki projektu.",
    ...
    certs_title: "Uprawnienia i certyfikaty", certs_desc: "SEP E i D, UDT na podesty ruchome (nożycowe i koszowe).",
  ...
  en: {
    ...
    hero_desc: "We specialize in comprehensive industrial installation works. Team size and scope of work are tailored to each client's requirements and project specifics.",
    ...
    certs_title: "Qualifications & certificates", certs_desc: "SEP E & D, UDT for mobile elevating work platforms (scissor and boom).",
  ...
  ko: {
    ...
    hero_desc: "저희는 종합적인 산업용 전기 설치 공사를 전문으로 합니다. 팀 규모와 작업 범위는 고객의 요구사항과 프로젝트 특성에 맞춰 조정됩니다.",
    ...
    certs_title: "자격증 및 인증서", certs_desc: "SEP E/D, 이동식 고소 작업대 UDT (가위형 및 붐형).",
  ...
  it: {
    ...
    hero_desc: "Siamo specializzati in lavori di installazione industriale completi. Dimensione del team e ambito dei lavori sono adattati alle esigenze del cliente e alle specifiche del progetto.",
    ...
    certs_title: "Qualifiche e certificati", certs_desc: "SEP E e D, UDT per piattaforme elevabili (a forbice e a braccio).",
  ...
  uk: {
    ...
    hero_desc: "Спеціалізуємося на комплексних промислових монтажних роботах. Розмір бригади та обсяг робіт підбираємо під вимоги замовника і специфіку проєкту.",
    ...
    certs_title: "Допуски та сертифікати", certs_desc: "SEP E і D, UDT на підйомні платформи (ножичні та стрілові).",
